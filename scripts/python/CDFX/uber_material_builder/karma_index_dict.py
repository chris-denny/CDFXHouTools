karma_index_dict = {        
    ...
    ("albedo",          "detail_cc", "detail"):     {"target_index": 0},
    ("albedo",          "detailout", "detail"):     {"target_index": 0},
    # Metalness
    ...
    ("reflection",      "detail_cc", "detail"):     {"target_index": 0},
    ("reflection",      "detailout", "detail"):     {"target_index": 0},
    # Roughness
    ...
    ("transmission",    "detail_cc", "detail"):     {"target_index": 0},
    ("transmission",    "detailout", "detail"):     {"target_index": 0},
    # Subsurface Color
    ...
    ("mscolor",         "detail_cc", "detail"):     {"target_index": 0},
    ("mscolor",         "detailout", "detail"):     {"target_index": 0},
    # Subsurface Radius
    ...
    ("msradius",        "detail_cc", "detail"):     {"target_index": 0},
    ("msradius",        "detailout", "detail"):     {"target_index": 0},
    # Sheen
    ...
    ("sheen",           "detail_cc", "detail"):     {"target_index": 0},
    ("sheen",           "detailout", "detail"):     {"target_index": 0},
    # Coat Roughness
    ...
    ("emcolor",         "detail_cc", "detail"):     {"target_index": 0},
    ("emcolor",         "detailout", "detail"):     {"target_index": 0},
    # Emission Intensity
    ...
    ("opacity",         "tex", "detail"):           {"target_index": 1},
    ("opacity",         "hex", "detail"):           {"target_index": 1},
    ("opacity",         "triplanar", "detail"):     {"target_index": 1},
    ("opacity",         "hextri", "detail"):        {"target_index": 1},
    ("opacity",         "detail_cc", "detail"):     {"target_index": 0},
    ("opacity",         "detailout", "detail"):     {"target_index": 0},
    # Bump
    ("bump",            "source", "shader"):        {"target_index": 40},
    ("bump",            "detail", "output"):        {"target_index": 1},
    ("bump",            "detail", "shader"):        {"target_index": 40},
    ("bump",            "roundcorner", "output"):   {"target_index": 2},
    ("bump",            "roundcorner", "shader"):   {"target_index": 40},
    ("bump",            "output", "shader"):        {"target_index": 40},
    ("bump",            None, "shader"):            {"target_index": 40},
    # Displacement
    ("displacement",    "output", "material"):      {"target_index": 1},
    ("displacement",    None, "material"):          {"target_index": 1},
    ("displacement",    "detail_cc", "detail"):     {"target_index": 1},
    ("displacement",    "dispdetailout", "detail"): {"target_index": 1},
    # Detail out
    ("detail_a",        "output", "detailout"):     {"target_index": 0},
    ("detail_a",        None, "detailout"):         {"target_index": 0},
    ("detail_b",        "output", "detailout"):     {"target_index": 1},
    ("detail_b",        None, "detailout"):         {"target_index": 1},
    ("detail_c",        "output", "detailout"):     {"target_index": 2},
    ("detail_c",        None, "detailout"):         {"target_index": 2},
}